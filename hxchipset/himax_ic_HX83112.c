...
static void hx83112a_read_ic_ver(void)
{
	...
	/* Enable read DD */
	kp_himax_in_parse_assign_cmd(hx83112_ic_osc_en, tmp_addr,
			sizeof(tmp_addr));
	...
	kp_himax_in_parse_assign_cmd(hx83112_ic_osc_pw, tmp_addr,
			sizeof(tmp_addr));
	kp_g_core_fp->fp_register_read(tmp_addr, DATA_LEN_4, tmp_data, 0);
	tmp_data[0] = 0xA5;
	kp_g_core_fp->fp_register_write(tmp_addr, DATA_LEN_4, tmp_data, false);
	...
	tmp_data[2] = 0x11;
	tmp_data[3] = 0x2A;
	kp_himax_in_parse_assign_cmd(hx83112_ic_b9_en,
		tmp_addr,
		sizeof(tmp_addr));
	kp_g_core_fp->fp_register_write(tmp_addr, DATA_LEN_4, tmp_data, false);
	...
	tmp_data[2] = 0xAA;
	tmp_data[3] = 0x00;
	kp_himax_in_parse_assign_cmd(hx83112_ic_eb_en,
		tmp_addr,
		sizeof(tmp_addr));
	...
	/* Read DD data */
	kp_himax_in_parse_assign_cmd(hx83112_cb_ic_fw,
		tmp_addr,
		sizeof(tmp_addr));
	kp_g_core_fp->fp_register_read(tmp_addr, DATA_LEN_4, tmp_data, 0);
	I("CB=%X\n", tmp_data[0]);
	...
	kp_himax_in_parse_assign_cmd(hx83112_e8_ic_fw,
		tmp_addr,
		sizeof(tmp_addr));
	kp_g_core_fp->fp_register_read(tmp_addr, DATA_LEN_4, tmp_data, 0);
	I("E8=%X\n", tmp_data[0]);
